...
click_order_join %>% 
    ...
    ggplot(aes(x = itinerary_travel_time, y = itinerary_sales_price, col = mobile)) +
    geom_point(alpha = 0.5, size = 0.5) +
    scale_x_log10(label = scales::comma) +
    scale_y_log10(label = scales::comma) +
    labs(x = "Log of Travel Time (Minutes)", y = "Log of Ticket Price (SEK)") +
